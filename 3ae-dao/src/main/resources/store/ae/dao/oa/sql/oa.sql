...
values
	...
	(1001, 'caiwu', '15ab525b4437e93aa2a618d700845d25', '1000-1000-1000-1000-1000-1000', 0),
	(1002, 'wenyuan', '15ab525b4437e93aa2a618d700845d25', '1000-1000-1000-1000-1000-1000', 0);
...
`ascriptor` varchar(32) NOT NULL COMMENT '归属人',
`expenses_type` varchar(32) NOT NULL COMMENT '费用分类',
`department_type` varchar(32) NOT NULL COMMENT '部门类别',
`receive_company` varchar(32) NOT NULL COMMENT '收款单位',
`ascription` varchar(32) NOT NULL COMMENT '归属类别',
`project_num` varchar(32) NOT NULL COMMENT '项目编号',
`project_name` varchar(32) NOT NULL COMMENT '项目名称',
`class_type` varchar(32) NOT NULL COMMENT '分类标识',
...
`verify_id` bigint NOT NULL COMMENT '审核ID',
`payment_type` varchar(8) NOT NULL COMMENT '支付方式',
`payment_bank` varchar(16) NOT NULL COMMENT '银行账户',
`amount` decimal(12, 2) NOT NULL COMMENT '金额',
`voucher` bigint NOT NULL COMMENT '凭证号',
`handler` varchar(32) NOT NULL COMMENT '付款经办人',
`remark` varchar(240) NOT NULL COMMENT '备注',
...
-- 初始化数据
insert into tb_expenses_payment(identifier, verify_id, payment_type, payment_bank, amount, voucher, handler, payment_gmt, remark)
values
	('YX19010001', 1000, '网银', '工行', 21300.00, 325551420, '姜叶', '2019-1-3', '无');
