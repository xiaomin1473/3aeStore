...
`discount` decimal NOT NULL DEFAULT 0 COMMENT '优惠金额 默认0',
...
-- 初始化数据
insert into tb_order(logistics_id, category_type, discount_way, discount, payment, invoice, order_status, after_sale_status)
values
	(1000, 1010101, 0, 0, 0, 0, -1, -1);
...
`sku_price` decimal NOT NULL DEFAULT 0 COMMENT '商品金额',
...
`delivery_name` varchar(32) NOT NULL COMMENT '收货联系人姓名',
`delivery_phone` bigint NOT NULL COMMENT '收货联系人手机号',
...
-- 初始化数据
insert into tb_order_user(order_id, user_id, category_type, user_name, delivery_name, delivery_phone, address)
values
	(1000, 1000, 1010101, "xiaomin1473", "赵宇明", 18235010340, "天上人间");
