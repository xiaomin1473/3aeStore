...
`deliver_name` varchar(120) NOT NULL COMMENT '收货联系人姓名',
`deliver_phone` bigint NOT NULL COMMENT '收货联系人手机号',
`deliver_address` varchar(120) NOT NULL COMMENT '收货地址',
...
-- 初始化数据
insert into tb_user_deliver(deliver_id, user_id, deliver_name, deliver_phone, deliver_address, option_name, option_phone)
values
